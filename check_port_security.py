...
def disable_port_security(conn, port, dry_run=False):
    ...
    [1]: https://github.com/openstack/openstacksdk/blob/88f6a31d7338e9fc03ce0219ddde022426d21780/openstack/resource.py#L1503  # noqa: E501
    """
...
def write_output(path, content, append=False):
    # always update output file, so nrpe check can know it's still working
